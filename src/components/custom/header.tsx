            ...
            <nav className='container py-5 flex items-center justify-between'>
                ...
                <div className='flex items-center gap-x-4'>
                    ...
                    <div className='relative'>
                        ...
                        <span className='absolute -top-4 -right-5 h-6 w-6 flex items-center justify-center rounded-full bg-primary font-bold text-white'>3</span>
                    </div>
                    <div className='flex items-center ml-12'><Phone />
                        <span>+01 9586 XXXX</span>
                    </div>
